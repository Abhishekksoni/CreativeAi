...
const DashboardLayout = () => {
  ...
  // If not authenticated, show landing page only
  if (!user) {
    return <LandingPage />;
  }
  ...
  return (
    <div className="flex flex-col h-screen relative">
      ...
      <div className="flex flex-1 mt-[60px] relative">
        {/* Sidebar Section (only shown if user exists) */}
        <aside
        ...
        <main className="flex-1 p-6 overflow-y-auto transition-all duration-300 lg:ml-[250px]">
          <MainContentPage />
          <Outlet />
        </main>
